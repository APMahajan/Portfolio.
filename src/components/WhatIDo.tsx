        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Developing robust backend services, RESTful APIs, and reliable
                transaction workflows using Java, Spring Boot, Hibernate/JPA,
              ...
              <div className="what-content-flex">
                ...
                <div className="what-tags">DSA & OOP</div>
              </div>
          ...
          >
            ...
            <div className="what-content-in">
              <h3>DEVOPS & CLOUD</h3>
              <h4>Platforms & Systems</h4>
              <p>
                Automating CI/CD pipelines with Jenkins and Docker, streamlining
                Linux shell operations, integrating AI APIs, and working with
                modern cloud and big data platforms.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
                ...
                <div className="what-tags">Cloud Platforms</div>
